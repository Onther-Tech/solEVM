...
import "./VerifierStorage.sol";


contract EnforcerStorage {

    uint256 public challengePeriod;
    uint256 public maxExecutionDepth;
    uint256 public bondAmount;
    VerifierStorage public verifier;
    ...
    constructor(address _verifier, uint256 _challengePeriod, uint256 _bondAmount, uint256 _maxExecutionDepth) public {
        verifier = VerifierStorage(_verifier);
        ...
        public payable
    {
        ...
        require(execution.startBlock + challengePeriod > block.number + (execution.executionDepth + 1) * verifier.timeoutDuration(),
