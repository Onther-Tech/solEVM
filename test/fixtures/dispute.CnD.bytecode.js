...
module.exports = (callback) => {
  ...
  // caller
    ...
    it('solver has an wrong code in depth 1', async () => {
      ...
      const correctFragmentTree = new FragmentTree().run(solverMerkle.tree[0][272].code);
    ...
    it('challenger has an wrong code in depth 1', async () => {
      ...
      const correctFragmentTree = new FragmentTree().run(challengerMerkle.tree[0][272].code);
      const correctCodeHash = correctFragmentTree.root.hash;
      console.log('wrongCodeHash', wrongCodeHash);
      console.log('correctCodeHash', correctCodeHash)
      console.log('wrongCodeHash === correctCodeHash', wrongCodeHash === correctCodeHash)
    ...
    it('solver has an wrong code in depth 2', async () => {
      ...
      const correctFragmentTree = new FragmentTree().run(solverMerkle.tree[0][495].code);
      const correctCodeHash = correctFragmentTree.root.hash;
      console.log('wrongCodeHash', wrongCodeHash);
      console.log('correctCodeHash', correctCodeHash)
      console.log('wrongCodeHash === correctCodeHash', wrongCodeHash === correctCodeHash)
    ...
    it('challenger has an wrong code in depth 2', async () => {
      ...
      const correctFragmentTree = new FragmentTree().run(challengerMerkle.tree[0][495].code);
      const correctCodeHash = correctFragmentTree.root.hash;
      console.log('wrongCodeHash', wrongCodeHash);
      console.log('correctCodeHash', correctCodeHash)
      console.log('wrongCodeHash === correctCodeHash', wrongCodeHash === correctCodeHash)
